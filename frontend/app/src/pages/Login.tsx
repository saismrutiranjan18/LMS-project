    ...
    <div className="w-full max-w-md mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              className="border-[#718096] data-[state=checked]:bg-[#0056D1] data-[state=checked]:border-[#0056D1]"
            />
          ...
          <Link 
            to="/forgot-password" 
            className="text-sm text-[#0056D1] hover:underline font-medium"
          >
            Forgot password?
          </Link>
        </div>
      ...
      <div className="relative my-8">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[#E6F0FF]" />
        </div>
        <div className="relative flex justify-center">
          <span className="px-4 bg-[#F8FAFC] text-sm text-[#718096]">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button
          type="button"
          variant="outline"
          className="h-12 border-[#E6F0FF] hover:bg-[#E6F0FF] rounded-xl"
        >
      ...
      {/* Sign Up Link */}
      <p className="text-center mt-8 text-[#718096]">
        Don't have an account?{' '}
        <Link to="/register" className="text-[#0056D1] font-semibold hover:underline">
          Sign up
        </Link>
      </p>
    </div>
